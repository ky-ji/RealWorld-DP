...
def main(input, output, robot_ip, match_dataset, match_episode,
    ...
    if 'diffusion' in cfg.name:
        ...
        # check if delta_action is enabled
                ...
                try:
                    ...
                    while True:
                        ...
                        if delta_action:
                            ...
                            # Support both 2D and 7D delta actions
                            ...
                            if action_dim == 2:
                                ...
                                # Add delta to position and rotation (first 6 dims)
                                this_target_pose[:6] += action[-1, :6]
                                # Gripper is absolute, not delta
                                this_target_pose[6] = action[-1, 6]
                            else:
                                raise ValueError(f"Unsupported action dimension for delta_action: {action_dim}")
