...
echo "命令: torchrun --nproc_per_node=$NUM_GPUS --master_port=50500 train_ddp.py --config-name=train_assembly_chocolate_ddp_color"
echo ""
...
torchrun \
    ...
    --master_port=50500 \
    train_ddp.py \
    --config-name=train_assembly_chocolate_ddp_color
